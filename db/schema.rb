...
ActiveRecord::Schema[7.1].define(version: 2024_07_04_122001) do
  ...
  create_table "moderators", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["confirmation_token"], name: "index_moderators_on_confirmation_token", unique: true
    ...
    t.index ["unlock_token"], name: "index_moderators_on_unlock_token", unique: true
  end
